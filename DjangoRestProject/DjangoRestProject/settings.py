...
SECRET_KEY = '#-qzj7(3b^%6s*u8$1%t96$!zjanq(4rv^&9&-x()ao=o8w(ce'
...
INSTALLED_APPS = [
    ...
    #below apps are use created
    'crudapp',
    #below is to use DRF viewwrappers
    'rest_framework'
]
...
EMAIL_HOST_PASSWORD = '' #paste the key or app password here
EMAIL_PORT = 587
EMAIL_USE_TLS = True
